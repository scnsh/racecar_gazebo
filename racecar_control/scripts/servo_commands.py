...
def set_throttle_steer(data):
    ...
    pub_pos_left_steering_hinge = rospy.Publisher(
        '/racecar/left_steering_hinge_position_controller/command', Float64, queue_size=1)
    pub_pos_right_steering_hinge = rospy.Publisher(
        '/racecar/right_steering_hinge_position_controller/command', Float64, queue_size=1)
...
def servo_commands():
    ...
    rospy.Subscriber("/racecar/ackermann_cmd_mux/output",
